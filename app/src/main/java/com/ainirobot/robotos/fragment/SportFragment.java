...
public class SportFragment extends BaseFragment {
    ...
    private void initViews(View root) {
        ...
        mGo_back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                RobotApi.getInstance().goBackward(0, 0.2f,1, mMotionListener);
                LogTools.info("back");
            }
        });
        ...
        mTurn_left.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                RobotApi.getInstance().turnLeft(0, 0.2f, 10,mMotionListener);
                LogTools.info("turn left");
            }
        });
        ...
        mTurn_right.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                RobotApi.getInstance().turnRight(0, 0.2f,10, mMotionListener);
                LogTools.info("turn right");
            }
        });
